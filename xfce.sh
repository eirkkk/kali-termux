...
sudo apt install kali-desktop-xfce xfce4-goodies xfce4-terminal tigervnc-standalone-server tigervnc-common dbus-x11 ffmpeg --no-install-recommends -y
...
wget https://raw.githubusercontent.com/eirkkk/kali-termux/main/ubchromiumfix.sh && chmod +x ubchromiumfix.sh
...
vncpasswd
wget -q https://raw.githubusercontent.com/eirkkk/kali-termux/main/.profile -O $HOME/.profile.1 > /dev/null
